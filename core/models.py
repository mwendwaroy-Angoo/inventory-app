...
class Store(models.Model):
    ...
    # NEW: Which business types this store is suitable for (used for filtering)
...
class Item(models.Model):
    ...
    # NEW: Link to business for data isolation
...
class Transaction(models.Model):
    ...
    qty = models.IntegerField()  # Positive for Receipt, Negative for Issue
