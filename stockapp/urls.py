...
from core.kitchen_views import (
    ...
    split_kitchen_batch,
    edit_raw_material_cost,
    reset_preset_restock_anchor,
...
urlpatterns = [
    ...
    path("bar/transactions/<int:txn_id>/correct-date/", correct_transaction_date, name="correct_transaction_date"),
    path("bar/transactions/<int:txn_id>/split-payment/", split_transaction_payment_method, name="split_transaction_payment_method"),
    path("bar/transactions/<int:txn_id>/revert-to-tab/", revert_direct_sale_to_tab, name="revert_direct_sale_to_tab"),
    ...
    path("kitchen/batch/<int:batch_id>/split/", split_kitchen_batch, name="split_kitchen_batch"),
    path("kitchen/item/<int:item_id>/edit-raw-cost/", edit_raw_material_cost, name="edit_raw_material_cost"),
    path("kitchen/item/<int:item_id>/reset-restock-anchor/", reset_preset_restock_anchor, name="reset_preset_restock_anchor"),
    ...
    path("kitchen/viability/",                    kitchen_viability_report,      name="kitchen_viability_report"),
